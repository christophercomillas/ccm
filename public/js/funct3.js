    ...
    $('#clearcheck3').click(function(e){
        ...
        if(idsArr.length > 0 || bArr.length > 0)
        {
            swal({
                ...
                if(response)
                {
                    checkClearing3('checktagging3',idsArr,bArr);    
                }
                else 
                {
        ...
        swal({
            title: "Error",
            type: "warning",
            text: "Please tag at least one check updates.",
            showCancelButton: false,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: "OK",
            closeOnConfirm: true
...
// End Due Check Clearing
function checkClearing3(url,ids,bids)
{
    var remarks = $('form#_pdctagclearing input#remarks').val();
                    ...
                    try{
                        ...
                        if (output.readyState == 3) {
                            ...
                            if(result.status=='complete')
                            {
                                ...
                                swal({
                                    title: "Success",
                                    text: "Tagged checks successfully updated.",
                                    type: "success",
                                    //confirmButtonColor: "#DD6B55",
                                    confirmButtonText: "Ok",
                                    closeOnConfirm: false,
