		...
		<div class="col-md-12">
			<div class="panel panel-default">
			 	<div class="panel-heading">
					<div class="row">
						<div class="col-xs-2">
                            <span class="glyphicon glyphicon-list-alt"></span> Checks for Deposit
                    ...
                    <div class="row" id="_checkssearch" style="display:none;">
                        <form class="form-horizontal" method="GET" id="formCheckSearch" action="{{ route('checksfordeposit') }}">
			 	...
			 	<div class="panel-body">
                    @include('check.loadchecksfordeposit')
			 	</div>				
			</div>
		</div>
	</div>
