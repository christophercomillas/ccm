			...
			<div class="panel panel-default">
			 	<div class="panel-heading">
					<div class="row">
                        ...
                        {{-- <input type="hidden" value="{{ route('editcheckdialog') }}" id="editcheckroute"> --}}
						
						<div class="col-xs-2">
							<h5><span class="glyphicon glyphicon-list-alt"></span> Check Receiving</h5>
						</div>
						<div class="col-xs-offset-6 col-xs-2">
							<button type="button" class="btn btn-primary btn-sm btn-block" id="newcheck">
								<span class="glyphicon glyphicon-plus"></span> Add New Check
							</button>
						</div>
						<div class="col-xs-2">
